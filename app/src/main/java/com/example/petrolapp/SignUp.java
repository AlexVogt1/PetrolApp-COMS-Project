        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    try {
                           processUserNames(responseData); // the method to process and format of the response is called
  ...
  * the app*/
  ...
  /*this method is run when the sign up button is clicked by the user*/
    public void signup(View v){
        ...
        if(!validFirstName() | !validLastName() | !validateEmail() | !validateUsername() | !validatePassword() | !validateConfirmPassword()){
            return;
        }else{
